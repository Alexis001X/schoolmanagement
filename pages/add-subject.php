...
<form method="post" >
	<div id="wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Agregar una materia:</div>
							...
							<div class="row">
						 	<div class="col-lg-10">
										...
										<div class="form-group">
											<div class="col-lg-4">
					 <label>Codigo de la materia:<span id="" style="font-size:11px;color:Red">*</span>	</label>
											</div>
		...
		<div class="form-group">
		<div class="col-lg-4">
		<label>Nombre de la materia:<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
	...
	<br><br>								
		...
		<div class="form-group">
		<div class="col-lg-4">
		<label>Materia de continuidad 1:</label>
		</div>
		<div class="col-lg-6">
	...
	<br><br>	
     ...
     <div class="form-group">
		<div class="col-lg-4">
		<label>Materia de continuidad 2:</label>
		</div>
		<div class="col-lg-6">
	...
	<div class="form-group">
	<div class="col-lg-4">
	 <label>Materia de continuidad 3:</label>
	</div>
	<div class="col-lg-6">
	...
	<input type="submit" class="btn btn-primary" name="submit" value="Agregar materias"></button>
											</div>
