...
<form method="post" >
	...
	<?php include('leftbar.php');?>
		...
		<div id="page-wrapper">
		    ...
		    <div class="col-lg-4">
			<label>Selecciona la carrera:<span id="" style="font-size:11px;color:red">*</span>	</label>
			</div>
			<div class="col-lg-6">
...
<option VALUE="">SELECT</option>
		...
		<div class="form-group">
		<div class="col-lg-4">
		<label>Nombre de la carrera:<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
 <input class="form-control" name="c-full"  id="c-full" >
	 ...
	 <br><br>								
			...
			<div class="form-group">
		<div class="col-lg-4">
		<label>Periodo de ingreso:<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
	...
	<br><br>		
			...
			<div class="form-group">
		    <div class="col-lg-2">
			<label>Nombres completos<span id="" style="font-size:11px;color:red">*</span>	</label>
		...
		<div class="form-group">
		 ...
		 <input type="radio" name="gender" id="other" value="other"> &nbsp; Otros &nbsp;
			</div>
			</div>	
	<br><br>		
		     <div class="form-group">
			 <div class="col-lg-2">
			<label>Nombre del representante:<span id="" style="font-size:11px;color:red">*</span>	</label>
        ...
        <option VALUE="">SELECT</option>
        <option VALUE="200000">mayor a 750$</option>
        <option value="500000">mayor a 1000$</option>
        <option value="700000">menor de 750$</option>
		...
		<option value="other">Other</option>
			...
			<br><br>
		     ...
		     <div class="form-group">
			 <div class="col-lg-2">
			<label>Discapacidad:<span id="" style="font-size:11px;color:red">*</span></label>
		...
		<div class="row">
			<div class="col-lg-12">
			<div class="panel panel-default">
			<div class="panel-heading">Contactos de emergencia:</div>
			<div class="panel-body">
			<div class="row">
			<div class="col-lg-12">
			<div class="form-group">
		...
		<div class="form-group">
		    <div class="col-lg-2">
			<label>Cuidad de residencia:</label>
			</div>
			<div class="col-lg-4">
...
<option VALUE="">Provincia:</option>
 ...
 <select name="state" id="state"  class="form-control" onchange="showDist(this.value)" required="required">
	...
	<br><br><br><br>		
        ...
        <option value="">Select City</option>
			...
			<br><br>
		     ...
		     <div class="form-group">
			 <div class="col-lg-2">
			<label>Calle secundaria:<span id="" style="font-size:11px;color:red">*</span>
      ...
      <textarea class="form-control" rows="3" name="cadd"  id="cadd"></textarea>
        ...
        <div class="row">
			<div class="col-lg-12">
			<div class="panel panel-default">
			<div class="panel-heading">Antecedentes academicos:</div>
			<div class="panel-body">
			<div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                         <div class="col-lg-6">
			<th>&nbsp;&nbsp;&nbsp;&nbsp;Colegio:<span id="" style="font-size:11px;color:red">*</span>	</label></th>
			</div>   
            <div class="col-lg-6">
			<th>&nbsp;&nbsp;&nbsp;&nbsp;Años aprovados:</th>
			</div>   
              <div class="col-lg-6">
			 <th>&nbsp;&nbsp;&nbsp;&nbsp;Año de salida:<span id="" style="font-size:11px;color:red">*</span></th>
			</div>                                 
            </tr>
                                    </thead>
                                    <tbody>
	...
	<input type="submit" class="btn btn-primary" name="submit" value="Registrar datos"></button>
	</div>
	</div>			
	</div>
	</div><!--row!-->		
